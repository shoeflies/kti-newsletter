...
def get_special_companies():
    ...
    return {
        ...
        "LP 출자 동향": {
            "comment": ["국내 주요 기관 LP(모태펀드·성장금융·연기금·공제회 등)의 벤처펀드 출자 사업, 출자 공고, GP 운용사 선정 동향"],
            "keyword": ["모태펀드/벤처출자/성장금융/출자사업/한국벤처투자/운용사 선정/벤처펀드 결성/국민성장펀드"],
            "manager": [],
            # 특정 회사가 아닌 주제 모니터링 → 관련성 평가에서 "이 회사가 주인공인가" 기준을 쓰지 않음
            "topic_monitor": True
        },
    }
